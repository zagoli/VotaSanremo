defmodule VotaSanremoWeb.UserSettingsLive do
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      ...
      |> assign(:votes_privacy_form, to_form(user_changeset))
  ...
  def handle_event(
    ...
    case Accounts.update_user(socket.assigns.current_user, user_params) do
      {:ok, user} ->
        ...
        {:noreply, assign(socket, :votes_privacy_form, votes_privacy_form)}
