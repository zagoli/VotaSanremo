defmodule VotaSanremoWeb.UserAuth do
  use VotaSanremoWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_vota_sanremo_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      VotaSanremoWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule VotaSanremoWeb.PageLive do
        use VotaSanremoWeb, :live_view

        on_mount {VotaSanremoWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{VotaSanremoWeb.UserAuth, :ensure_authenticated}] do
  ...
  defp signed_in_path(_conn), do: ~p"/vote"
end
